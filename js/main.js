            ...
            (function (index) {
                ...
                artwork.onload = function () {
                    ...
                    if (index <= Math.floor(Gallery.num_of_paintings / 2) - 1) //bottom half
                    {
                        ...
                        //plane.position.set(65*i - 75*Math.floor(Gallery.num_of_paintings/2) - 15*Math.floor(num_of_paintings/2), 48, 90);
    ...
    render: function () {
        ...
        if (Gallery.controls.enabled === true) {
            ...
            for (var i = 0; i < Gallery.wallGroup.children.length; i++) {
                ...
                if (Gallery.user.BBox.isIntersectionBox(Gallery.wallGroup.children[i].BBox)) {
